...
# Enable RDP Bot - Cleanup Test Case 1
# This script removes the test1 VM and all associated resources
...
echo -e "${BLUE}🧹 Enable RDP Bot - Cleaning Up Test Case 1${NC}"
echo "=============================================="
echo "This script will remove the test1 VM and all associated resources."
echo ""
