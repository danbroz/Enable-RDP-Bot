...
# Enable RDP Bot - Cleanup Test Case 3
# This script removes the test3 VM and all associated resources
...
echo -e "${BLUE}🧹 Enable RDP Bot - Cleaning Up Test Case 3${NC}"
echo "=============================================="
echo "This script will remove the test3 VM and all associated resources."
echo ""
...
echo "The test3 VM and all associated resources are being removed."
echo ""
